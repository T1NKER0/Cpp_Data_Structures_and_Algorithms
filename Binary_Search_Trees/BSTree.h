...
void BSTree<T>::insert(T val)
{
  ...
  BSTNode<T>* newNode = new BSTNode<T>(nullptr, val, nullptr);
  ...
  if (root == nullptr) {
    ...
    while (current != nullptr) {
      ...
      if (val < current->getInfo()) {
        ...
        // If the value already exists in the tree, you may decide what to do
        // (e.g., ignore, update, or handle it in a way that fits your application).
        // For this example, we will ignore duplicates.
